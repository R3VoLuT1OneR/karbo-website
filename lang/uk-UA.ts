...
export default {
  ...
  hero: {
    title: {
      ...
      line2: 'Обмінна Одиниця',
    },
    subtitle: "створенна на основі <strong>блокчейн</strong> технології <strong>CryptoNote</strong>",
    githubContribution: 'Співробітничати на GitHub',

    downloadButton: {
      title: 'Завантажити Гаманець',
      wallets: {
        all: 'Всі гаманці та кліенти'
      },
    }
  },

  wallets: {
    windows: 'Гаманець для Windows',
    linux: 'Гаманець для Linux',
    macos: 'Гаманець для Mac OS X',
    android: 'Гаманець для Android',
    web: 'Web Гаманець',
    paper: 'Паперовий Гаманець',
  },
