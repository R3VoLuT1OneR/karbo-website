    ...
    let walletsList = [
      {
        os: 'windows',
        icon: 'windows',
        label: this.$i18n.t('Wallet for Windows'),
        href: '',
      },
      {
        os: 'ubuntu',
        icon: 'linux',
        label: this.$i18n.t('Wallet for Linux'),
        href: '',
      },
      {
        os: 'macOS',
        icon: 'apple',
        label: this.$i18n.t('Wallet for Mac OS X'),
        href: '',
      },
      {
        icon: 'android',
        href: 'https://play.google.com/store/apps/details?id=org.karbo.karbon',
        label: this.$i18n.t('Wallet for Android'),
      },
      {
        label: this.$i18n.t('Web Wallet'),
        icon: 'web',
        href: 'https://wallet.karbo.org/',
      },
      // {
      //   label: this.$i18n.t('Paper Wallet'),
      //   icon: 'paper',
      //   href: 'https://wallet.karbo.org/',
      // },
    ]
