        ...
        list: [
          {
            ...
            title: 'BTC Trade UA',
            subtitle: this.$t('usage.exchanges.btctrade.subtitle'),
            href: 'https://btc-trade.com.ua/stock/krb_uah',
          },
          {
            icon: 'usage/richamster',
            title: 'Richamster',
            subtitle: this.$t('usage.exchanges.richhamster.subtitle'),
            href: 'https://richamster.com/',
          },
          {
            icon: 'usage/tradeogre',
            title: 'TradeOgre',
            subtitle: this.$t('usage.exchanges.tradeogre.subtitle'),
            href: 'https://tradeogre.com/exchange/BTC-KRB',
          },
          {
            icon: 'usage/occe',
            title: 'OCCE',
            subtitle: this.$t('usage.exchanges.occe.subtitle'),
            href: 'https://www.occe.io/exchange/krb_btc',
          },
          {
            icon: 'usage/karbo24',
            title: 'Karbo24',
            subtitle: this.$t('usage.exchanges.karbo24.subtitle'),
            href: 'https://karbo24.io/',
          },
          {
            icon: 'usage/crex24',
            title: 'Crex24',
            subtitle: this.$t('usage.exchanges.crex24.subtitle'),
